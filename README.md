...
| Mod | Side | GTNH 1.7.10 | Fabric 26.2 · 26.1 · 1.21.1 | NeoForge 26.2 · 26.1 · 1.21.1 |
| --- | --- | :-: | :-: | :-: |
...
- **Fabric 26.2, 26.1 and 1.21.1:** also needs Fabric API, Fabric Language Kotlin and Forge Config API Port. Mod Menu is optional, for the config screens.
- **NeoForge 26.2, 26.1 and 1.21.1:** also needs Kotlin for Forge.
