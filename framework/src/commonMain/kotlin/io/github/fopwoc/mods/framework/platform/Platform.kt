...
object Platform {
    ...
    private val backend: PlatformBackend by lazy {
        checkNotNull(
                ServiceLoader.load(
                        PlatformBackend::class.java,
                        PlatformBackend::class.java.classLoader,
                    )
                    .firstOrNull()
            ) {
    ...
    val minecraftVersion: String
        get() = backend.minecraftVersion

    val isClient: Boolean
        get() = backend.isClient

    val gameDirectory: File
        get() = backend.gameDirectory

    val configDirectory: File
        get() = backend.configDirectory
