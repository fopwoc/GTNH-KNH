        ...
        get() =
            when (this) {
                is ComposeLeafProjection.Text ->
                    LayoutShape.Text(modifier = modifier, text = text, style = style)
                is ComposeLeafProjection.Button ->
                    LayoutShape.Button(modifier = modifier, text = text)
                is ComposeLeafProjection.Checkbox ->
                    LayoutShape.Checkbox(modifier = modifier, label = label)
