...
class LayoutEngineTest {
    ...
    fun wrappedTextUsesMultipleLinesWhenWidthIsConstrained() {
        val wrappedText =
            LayoutElement.Text(
                text =
                    StyledText.of("Wrapped text should span multiple lines in a narrow container"),
            ...
            LayoutElement.Box(
                ...
                children =
                    listOf(
                        ...
                        LayoutElement.Spacer(
                            modifier =
                                Modifier.size(60.uu, 8.uu).boxParentData(matchParentWidth = true)
                        ),
                    ),
            )
                ...
                children =
                    listOf(
                        ...
                        LayoutElement.Spacer(
                            modifier =
                                Modifier.size(10.uu)
                                    .rowParentData(alignment = VerticalAlignment.BOTTOM)
                        ),
                    ),
            )
            ...
            LayoutElement.Column(
                ...
                children =
                    listOf(
                        ...
                        LayoutElement.Spacer(
                            modifier =
                                Modifier.size(10.uu, 5.uu)
                                    .columnParentData(weight = 1f, fill = false)
                        ),
                    ),
            )
    ...
    fun nestedScrollableListCardsCanScrollLastButtonFullyIntoView() {
        val description =
            "Cras mattis consectetur purus sit amet fermentum, " +
                "stacked with flour sacks and scribbled shopping lists that should wrap in narrow viewports."
        val scrollState = ScrollState()
        val scrollable =
            ColumnNode(
                    modifier =
        ...
        val root =
            RootNode().apply {
                children +=
                    ColumnNode(
                            modifier =
                                Modifier.width(220.uu).height(120.uu).verticalScroll(scrollState),
                            verticalArrangement = VerticalArrangement.spacedBy(4.uu),
                            horizontalAlignment = HorizontalAlignment.START,
                        )
                        .also { scrollColumn ->
                            scrollColumn.children +=
                                ColumnNode(
                                    ...
                                    .also { tallContent ->
                                        repeat(6) { index ->
                                            val description =
                                                "Tall section ${index + 1} with enough text " +
                                                    "to need its full measured height"
                                            tallContent.children +=
                                                TextNode(
                                                    modifier = Modifier.fillMaxWidth(),
                                                    text = StyledText.of(description),
                                                    style = TextStyle(wrap = true),
                                                )
                                            tallContent.children +=
        ...
        val root =
            RootNode().apply {
                children +=
                    RowNode(
                            modifier =
                                Modifier.width(120.uu).height(60.uu).horizontalScroll(scrollState),
                            horizontalArrangement = HorizontalArrangement.spacedBy(4.uu),
                            verticalAlignment = VerticalAlignment.TOP,
                        )
                        .also { scrollRow ->
                            scrollRow.children +=
                                RowNode(
                                        ...
                                        horizontalArrangement =
                                            HorizontalArrangement.spacedBy(4.uu),
                                        verticalAlignment = VerticalAlignment.TOP,
                                    )
                                    .also { wideContent ->
                                        repeat(6) { index ->
                                            wideContent.children +=
                                                SpacerNode(
                                                    modifier = Modifier.width(36.uu).height(20.uu)
                                                )
                                            wideContent.children +=
                                                TextNode(
                                                    modifier = Modifier,
