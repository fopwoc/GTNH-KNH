...
internal object GpuTextureDeletion {
    ...
    fun delete(texture: Int) {
        ...
        try {
            ...
            backend.javaClass
                .getMethod("deleteTextures", Int::class.javaPrimitiveType)
                .invoke(backend, texture)
        } catch (failure: ReflectiveOperationException) {
            // Angelica's public deletion path assumes GL_TEXTURE_2D and can overwrite the GUI
            // atlas.
