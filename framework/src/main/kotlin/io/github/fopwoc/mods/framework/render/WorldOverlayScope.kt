...
class WorldOverlayScope internal constructor(val camera: WorldCamera) {
     ...
     * show as ghosts. The overlay is otherwise depth-free; use this for small things such as
     * anchors.
     */
    ...
    internal fun drawQueuedLabels(minecraft: Minecraft) {
        ...
        GL11.glPushAttrib(
            GL11.GL_ENABLE_BIT or GL11.GL_COLOR_BUFFER_BIT or GL11.GL_DEPTH_BUFFER_BIT
        )
