...
internal fun LayoutElement.Box.boxMeasureSpec(maxWidth: Int, maxHeight: Int): BoxMeasureSpec = BoxMeasureSpec(
    maxWidth = maxWidth,
    maxHeight = maxHeight,
...
internal fun LayoutElement.Box.boxPlacementSpec(contentRect: Rect): BoxPlacementSpec = BoxPlacementSpec(
