...
internal fun measureButtonNaturalSize(
  ...
  return Size(
      width =
          max(98, metrics.textWidth(element.text.formattedString) + 20 + padding.horizontalValue),
...
internal fun measureCheckboxNaturalSize(
  ...
  return Size(
      width =
          max(11, metrics.textWidth(element.label.formattedString) + 13 + padding.horizontalValue),
