...
internal fun LayoutElement.Row.stackMeasureSpec(maxWidth: Int, maxHeight: Int): StackMeasureSpec =
    StackMeasureSpec(
...
internal fun LayoutElement.Column.stackMeasureSpec(
    maxWidth: Int,
    maxHeight: Int,
): StackMeasureSpec =
    StackMeasureSpec(
...
internal fun LayoutElement.Row.stackPlacementSpec(
...
internal fun LayoutElement.Column.stackPlacementSpec(
    children: List<LayoutNode>,
    contentRect: Rect,
): StackPlacementSpec =
    StackPlacementSpec(
...
internal fun LayoutElement.ScrollableRow.stackPlacementSpec(
    children: List<LayoutNode>,
    contentRect: Rect,
): StackPlacementSpec =
    StackPlacementSpec(
...
internal fun LayoutElement.ScrollableColumn.stackPlacementSpec(
    children: List<LayoutNode>,
    contentRect: Rect,
): StackPlacementSpec =
    StackPlacementSpec(
