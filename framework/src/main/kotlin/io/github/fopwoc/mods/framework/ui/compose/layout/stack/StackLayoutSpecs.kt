...
internal fun LayoutElement.Row.stackPlacementSpec(children: List<LayoutNode>, contentRect: Rect): StackPlacementSpec = StackPlacementSpec(
    axis = StackAxis.HORIZONTAL,
...
internal fun LayoutElement.Column.stackPlacementSpec(children: List<LayoutNode>, contentRect: Rect): StackPlacementSpec = StackPlacementSpec(
    axis = StackAxis.VERTICAL,
    contentRect = contentRect,
...
internal fun LayoutElement.ScrollableRow.stackPlacementSpec(children: List<LayoutNode>, contentRect: Rect): StackPlacementSpec = StackPlacementSpec(
    axis = StackAxis.HORIZONTAL,
    contentRect = contentRect,
    mainAxisPositions = horizontalArrangement.arrange(
        totalSize = contentRect.width,
...
internal fun LayoutElement.ScrollableColumn.stackPlacementSpec(children: List<LayoutNode>, contentRect: Rect): StackPlacementSpec = StackPlacementSpec(
    axis = StackAxis.VERTICAL,
    contentRect = contentRect,
    mainAxisPositions = verticalArrangement.arrange(
        totalSize = contentRect.height,
