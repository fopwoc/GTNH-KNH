...
internal class MinecraftHostedWidgetRegistry {
    ...
    fun ownsButton(hostKey: HostedWidgetKey, hosted: HostedButton): Boolean = buttons[hostKey] === hosted
    ...
    fun ownsCheckbox(hostKey: HostedWidgetKey, hosted: HostedCheckbox): Boolean = checkboxes[hostKey] === hosted

    fun getOrCreateTextField(hostKey: HostedWidgetKey, create: () -> HostedTextField): HostedTextField =
        textFields[hostKey] ?: create().also { textFields[hostKey] = it }
    ...
    fun ownsSlider(hostKey: HostedWidgetKey, hosted: HostedSlider): Boolean = sliders[hostKey] === hosted
