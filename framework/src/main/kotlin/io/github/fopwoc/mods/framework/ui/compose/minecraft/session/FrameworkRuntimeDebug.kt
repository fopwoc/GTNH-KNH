...
object FrameworkRuntimeDebug {
    ...
    internal fun updateRuntimeFailure(failure: String) {
        ...
        runtimeFailure = when {
            ...
            current.startsWith("recomposeJob:CancellationException:Recomposer effect job completed") -> failure
            failure.startsWith("recomposeJob:CancellationException:Recomposer effect job completed") -> current
            else -> failure
        }
    }
