 ...
 *
 * This stays as a dedicated reference type so the hosting registry cannot accidentally be keyed by
 * value-based objects such as strings or data classes, which would not work with its identity-based
 * storage.
 */
