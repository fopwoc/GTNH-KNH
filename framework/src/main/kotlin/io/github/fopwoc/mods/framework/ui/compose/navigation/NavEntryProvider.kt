...
class NavEntryProvider<K : NavKey> internal constructor(
...
fun <K : NavKey> entryProvider(builder: NavEntryProviderBuilder<K>.() -> Unit): NavEntryProvider<K> =
    NavEntryProviderBuilder<K>().apply(builder).build()
