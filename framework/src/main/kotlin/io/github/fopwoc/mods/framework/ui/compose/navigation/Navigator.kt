...
private class NavBackStackNavigator<K : NavKey>(
    override val backStack: NavBackStack<K>
) : Navigator<K> {
...
@Composable
fun <K : NavKey> rememberNavigator(backStack: NavBackStack<K>): Navigator<K> = remember(backStack) {
    backStack.navigator()
}
