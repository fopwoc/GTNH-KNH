...
class FrameworkBootstrapTest {
  ...
  fun forgeEntrypointUsesJava8BytecodeAndCurrentModVersion() {
    val classFile =
        DataInputStream(FrameworkBootstrap::class.java.getResourceAsStream("FrameworkBootstrap.class"))
    classFile.use {
    ...
    assertEquals(MOD_VERSION, FrameworkBootstrap::class.java.getAnnotation(Mod::class.java).version)
  }
