...
class InputDispatchTest {
    ...
    fun clippedTargetIsIgnoredByHitTesting() {
        ...
        val actual = InputDispatcher.findTopmostPressTarget(listOf(unclipped, clippedOut), mouseX = 10, mouseY = 10)
    ...
    fun textFieldPressKeepsFocus() {
        ...
        val shouldBlur = InputDispatcher.shouldBlurFocusedTextFieldAfterPress(
            mouseButton = 0,
            target = target,
    ...
    fun pressCanCaptureDragAndReleaseSession() {
        ...
        val session = ActivePointerSession(
            button = 0,
