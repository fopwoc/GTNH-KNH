...
class LayoutEngineTest {
  ...
  fun composeTreeLayoutMatchesEquivalentLayoutElementLayout() {
                  ...
                  .also { boxNode ->
                    ...
                    boxNode.children +=
                        ColumnNode(
                            ...
                            .also { columnNode ->
                              columnNode.children +=
                                  SpacerNode(modifier = Modifier.fillMaxWidth().height(12.uu))
                              columnNode.children +=
                                  SpacerNode(modifier = Modifier.fillMaxWidth().height(12.uu))
                            }
                  }
                                    ...
                                    children =
                                        listOf(
                                            LayoutElement.Spacer(
                                                modifier = Modifier.fillMaxWidth().height(12.uu)
                                            ),
                                            LayoutElement.Spacer(
                                                modifier = Modifier.fillMaxWidth().height(12.uu)
                                            ),
    ...
    val nodeLayout =
        LayoutEngine.layout(rootNode, FakeTextMetrics(), viewportWidth = 120, viewportHeight = 120)
    val elementLayout =
        LayoutEngine.layout(
            layoutElementRoot,
            FakeTextMetrics(),
  ...
  fun composeTreeHostedLeavesMatchEquivalentLayoutElementLayout() {
    ...
    val nodeLayout =
        LayoutEngine.layout(rootNode, FakeTextMetrics(), viewportWidth = 280, viewportHeight = 220)
    val elementLayout =
        LayoutEngine.layout(
            layoutElementRoot,
            FakeTextMetrics(),
  ...
  fun centersPanelAndStretchesButtonsAcrossColumnWidth() {
    ...
    val layout =
        LayoutEngine.layout(root, FakeTextMetrics(), viewportWidth = 320, viewportHeight = 180)
  ...
  fun shadowedTextMeasuresOnePixelTallerThanPlainText() {
    ...
    val plainLayout =
        LayoutEngine.layout(plain, FakeTextMetrics(), viewportWidth = 200, viewportHeight = 200)
    val shadowedLayout =
        LayoutEngine.layout(shadowed, FakeTextMetrics(), viewportWidth = 200, viewportHeight = 200)
  ...
  fun composeTreeShadowedTextMeasuresOnePixelTallerThanPlainText() {
    ...
    val plainLayout =
        LayoutEngine.layout(plainRoot, FakeTextMetrics(), viewportWidth = 200, viewportHeight = 200)
    val shadowedLayout =
        LayoutEngine.layout(
            shadowedRoot,
            FakeTextMetrics(),
    ...
    assertEquals(
        plainLayout.children.single().bounds.width,
        shadowedLayout.children.single().bounds.width,
    )
    assertEquals(
        plainLayout.children.single().bounds.height + 1,
        shadowedLayout.children.single().bounds.height,
    )
  }
        ...
        LayoutElement.Box(
            ...
            children =
                listOf(
                    ...
                    LayoutElement.Spacer(
                        modifier =
                            Modifier.size(10.uu).boxParentData(alignment = Alignment.BottomEnd)
                    ),
                ),
        )

    val layout =
        LayoutEngine.layout(box, FakeTextMetrics(), viewportWidth = 80, viewportHeight = 80)
  ...
  fun anchoredBoxUsesStandardContentAlignmentAndOffsetPlacement() {
                ...
                listOf(
                    LayoutElement.Box(
                        ...
                        children =
                            listOf(
                                LayoutElement.Spacer(
                                    modifier = Modifier.size(7.uu).offset(y = 3.uu)
                                )
                            ),
                    )
                ),
    ...
    val layout =
        LayoutEngine.layout(root, FakeTextMetrics(), viewportWidth = 100, viewportHeight = 80)
        ...
        LayoutElement.Box(
            ...
            children =
                listOf(
                    LayoutElement.Spacer(modifier = Modifier.size(10.uu)),
                    LayoutElement.Spacer(
                        modifier = Modifier.size(60.uu).boxParentData(matchParentSize = true)
                    ),
                ),
        )
    ...
    val box =
        LayoutElement.Box(
            ...
            children =
                listOf(
                    LayoutElement.Spacer(
                        modifier = Modifier.size(48.uu).boxParentData(matchParentSize = true)
                    )
                ),
        )
        ...
        LayoutElement.Box(
            ...
            children =
                listOf(
                    ...
                    LayoutElement.Spacer(
                        modifier = Modifier.size(60.uu, 8.uu).boxParentData(matchParentWidth = true)
                    ),
                ),
        )
        ...
        LayoutElement.Box(
            ...
            children =
                listOf(
                    ...
                    LayoutElement.Spacer(
                        modifier =
                            Modifier.size(8.uu, 60.uu).boxParentData(matchParentHeight = true)
                    ),
                ),
        )
  ...
  fun nestedBoxAnchorCanPlaceHudWidgetRelativeToArbitraryScreenRect() {
    ...
    val layout =
        LayoutEngine.layout(root, FakeTextMetrics(), viewportWidth = 200, viewportHeight = 120)
    val anchor = layout.children.single()
  ...
  fun rowCenterArrangementCentersChildrenWithinAvailableWidth() {
    ...
    val layout =
        LayoutEngine.layout(row, FakeTextMetrics(), viewportWidth = 120, viewportHeight = 40)
        ...
        LayoutElement.Row(
            ...
            children =
                listOf(
                    ...
                    LayoutElement.Spacer(
                        modifier =
                            Modifier.size(10.uu).rowParentData(alignment = VerticalAlignment.BOTTOM)
                    ),
                ),
        )

    val layout =
        LayoutEngine.layout(row, FakeTextMetrics(), viewportWidth = 120, viewportHeight = 120)
        ...
        LayoutElement.Row(
            ...
            children =
                listOf(
                    ...
                    LayoutElement.Spacer(
                        modifier = Modifier.height(10.uu).rowParentData(weight = 1f)
                    ),
                    LayoutElement.Spacer(
                        modifier = Modifier.height(10.uu).rowParentData(weight = 2f)
                    ),
                ),
        )
        ...
        LayoutElement.Row(
            ...
            children =
                listOf(
                    ...
                    LayoutElement.Spacer(
                        modifier =
                            Modifier.size(5.uu, 10.uu).rowParentData(weight = 1f, fill = false)
                    ),
                ),
        )
    ...
    val row =
        LayoutElement.Row(
            ...
            children =
                listOf(
                    LayoutElement.Spacer(
                        modifier = Modifier.size(10.uu, 8.uu).rowParentData(weight = 1f)
                    )
                ),
        )
  ...
  fun columnSpaceBetweenArrangementDistributesExtraHeight() {
    ...
    val layout =
        LayoutEngine.layout(column, FakeTextMetrics(), viewportWidth = 40, viewportHeight = 120)
            ...
            children =
                listOf(
                    ...
                    LayoutElement.Spacer(
                        modifier =
                            Modifier.size(10.uu)
                                .columnParentData(alignment = HorizontalAlignment.END)
                    ),
                ),
        )

    val layout =
        LayoutEngine.layout(column, FakeTextMetrics(), viewportWidth = 120, viewportHeight = 120)
        ...
        LayoutElement.Column(
            ...
            children =
                listOf(
                    LayoutElement.Spacer(modifier = Modifier.size(10.uu, 10.uu)),
                    LayoutElement.Spacer(
                        modifier = Modifier.width(10.uu).columnParentData(weight = 1f)
                    ),
                    LayoutElement.Spacer(
                        modifier = Modifier.width(10.uu).columnParentData(weight = 2f)
                    ),
                ),
        )
        ...
        LayoutElement.Column(
            ...
            children =
                listOf(
                    ...
                    LayoutElement.Spacer(
                        modifier =
                            Modifier.size(10.uu, 5.uu).columnParentData(weight = 1f, fill = false)
                    ),
                ),
        )
  ...
  fun richTextMeasurementUsesVisibleGlyphWidthInsteadOfFormattingCodes() {
    ...
    val layout =
        LayoutEngine.layout(text, FakeTextMetrics(), viewportWidth = 120, viewportHeight = 40)
  ...
  fun composeTreeRichTextMeasurementUsesVisibleGlyphWidthInsteadOfFormattingCodes() {
    ...
    val layout =
        LayoutEngine.layout(root, FakeTextMetrics(), viewportWidth = 120, viewportHeight = 40)
    ...
    val column =
        LayoutElement.Column(
            ...
            children =
                listOf(
                    LayoutElement.Spacer(
                        modifier = Modifier.size(8.uu, 10.uu).columnParentData(weight = 1f)
                    )
                ),
        )
        ...
        LayoutElement.ScrollableColumn(
            ...
            children =
                listOf(
                    LayoutElement.Spacer(modifier = Modifier.size(10.uu, 10.uu)),
                    LayoutElement.Spacer(
                        modifier = Modifier.size(10.uu, 5.uu).columnParentData(weight = 1f)
                    ),
                ),
        )
  ...
  fun scrollColumnConsumesWheelInputAndUpdatesScrollState() {
    ...
    val scrollColumn =
        LayoutElement.ScrollableColumn(
            modifier = Modifier.width(140.uu).height(64.uu).padding(4.uu),
            verticalArrangement = VerticalArrangement.spacedBy(4.uu),
            horizontalAlignment = HorizontalAlignment.START,
            state = scrollState,
            children =
  ...
  fun scrollColumnScrollbarCanBeDragged() {
    ...
    val scrollColumn =
        LayoutElement.ScrollableColumn(
            modifier = Modifier.width(160.uu).height(72.uu).padding(4.uu),
            verticalArrangement = VerticalArrangement.spacedBy(4.uu),
            horizontalAlignment = HorizontalAlignment.START,
            state = scrollState,
            children =
  ...
  fun scrollRowConsumesWheelInputAndUpdatesScrollState() {
    ...
    val scrollRow =
        LayoutElement.ScrollableRow(
            modifier = Modifier.width(72.uu).height(40.uu).padding(4.uu),
  ...
  fun scrollRowScrollbarCanBeDragged() {
    ...
    val scrollRow =
        LayoutElement.ScrollableRow(
            modifier = Modifier.width(88.uu).height(40.uu).padding(4.uu),
            horizontalArrangement = HorizontalArrangement.spacedBy(4.uu),
            verticalAlignment = VerticalAlignment.TOP,
            state = scrollState,
            children =
  ...
  fun tooltipModifierRegistersWholeContainerBounds() {
    val box =
        LayoutElement.Box(
            ...
            contentAlignment = Alignment.Center,
            children = listOf(LayoutElement.Spacer(modifier = Modifier.size(10.uu))),
        )
  ...
  fun checkboxKeepsNaturalSizeForHostedRendering() {
    ...
    val layout =
        LayoutEngine.layout(checkbox, FakeTextMetrics(), viewportWidth = 200, viewportHeight = 40)
  ...
  fun styledButtonUsesVisibleGlyphWidthForNaturalSize() {
    ...
    val layout =
        LayoutEngine.layout(button, FakeTextMetrics(), viewportWidth = 200, viewportHeight = 80)
  ...
  fun textFieldUsesExpectedNaturalControlSize() {
    ...
    val layout =
        LayoutEngine.layout(textField, FakeTextMetrics(), viewportWidth = 200, viewportHeight = 80)
  ...
  fun sliderUsesExpectedNaturalControlSize() {
    ...
    val layout =
        LayoutEngine.layout(slider, FakeTextMetrics(), viewportWidth = 240, viewportHeight = 80)
                        ...
                        .also { panel ->
                          panel.children +=
                              BoxNode(
                                  ...
                                  .also { paddedContent ->
                                    paddedContent.children +=
                                        ColumnNode(
                                                modifier = Modifier.fillMaxWidth(),
                                                verticalArrangement =
                                                    VerticalArrangement.spacedBy(4.uu),
                                                horizontalAlignment = HorizontalAlignment.START,
                                            )
                                            .also { cardColumn ->
                                              cardColumn.children +=
                                              ...
                                              cardColumn.children +=
                                                  TextNode(
                                                      ...
                                                      text =
                                                          StyledText.of(
                                                              "Cras mattis consectetur purus sit amet fermentum, stacked with flour sacks and scribbled shopping lists that should wrap in narrow viewports."
                                                          ),
                                                      style =
                                                          TextStyle(
                                                              wrap = true,
  ...
  fun outerScrollableColumnMeasuresTallNestedColumnAtNaturalHeight() {
    ...
    val root =
        RootNode().apply {
          children +=
              ColumnNode(
                      modifier = Modifier.width(220.uu).height(120.uu).verticalScroll(scrollState),
                      verticalArrangement = VerticalArrangement.spacedBy(4.uu),
                      horizontalAlignment = HorizontalAlignment.START,
                  )
                  .also { scrollColumn ->
                    scrollColumn.children +=
                        ColumnNode(
                                modifier = Modifier.fillMaxWidth(),
                                verticalArrangement = VerticalArrangement.spacedBy(4.uu),
                                horizontalAlignment = HorizontalAlignment.START,
                            ...
                            .also { tallContent ->
                              repeat(6) { index ->
                                tallContent.children +=
                                    TextNode(
                                        modifier = Modifier.fillMaxWidth(),
                                        text =
                                            StyledText.of(
                                                "Tall section ${index + 1} with enough text to need its full measured height"
                                            ),
                                        style = TextStyle(wrap = true),
                                    )
                                tallContent.children +=
                                    SpacerNode(modifier = Modifier.height(20.uu))
                              }
                            }
                  }
        }
  ...
  fun outerScrollableRowMeasuresWideNestedRowAtNaturalWidth() {
    ...
    val root =
        RootNode().apply {
          children +=
              RowNode(
                      modifier = Modifier.width(120.uu).height(60.uu).horizontalScroll(scrollState),
                      horizontalArrangement = HorizontalArrangement.spacedBy(4.uu),
                      verticalAlignment = VerticalAlignment.TOP,
                  )
                  .also { scrollRow ->
                    scrollRow.children +=
                        RowNode(
                            ...
                            .also { wideContent ->
                              repeat(6) { index ->
                                wideContent.children +=
                                    SpacerNode(modifier = Modifier.width(36.uu).height(20.uu))
                                wideContent.children +=
                                    TextNode(
                                        modifier = Modifier,
  ...
  private fun assertLayoutTreeMatches(
