...
class KnhMpTargets internal constructor() {
    ...
    fun gtnh(configure: Action<in KnhMpTarget>) =
        configure.execute(add("gtnh", "gtnhMain", "reobfJar", "runClient25", 8))
    ...
    private fun add(name: String, sourceSet: String, buildTask: String, runTask: String, bytecodeMinimum: Int): KnhMpTarget {
        val target = KnhMpTarget(name, sourceSet, buildTask, runTask, bytecodeMinimum)
