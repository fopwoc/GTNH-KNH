        ...
        Column(
            ...
            Row(
                ...
                Button(
                    ...
                    modifier =
                        Modifier.weight(1f)
                            .tooltip("Ask the server to profile for the chosen window"),
                ...
                Button(
                    text = "Deselect",
                    modifier =
                        Modifier.weight(1f).tooltip("Drop every highlight; the snapshot stays"),
                    ...
                    SelectableList(
                        ...
                        modifier =
                            Modifier.fillMaxSize()
                                .weight(1f)
                                .tooltip(
                                    "Click a chunk to highlight it and list what ticks inside"
                                ),
                        rowHeight = 12.uu,
