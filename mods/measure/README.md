...
- Shift constrains placement: lines and sphere radii snap to an axis, areas become cubes (while placing, and while holding Shift + Cmd/Ctrl to select, Shift does not sneak; Shift + Space descends while placing)
...
| Constrain (axis / cube) | hold Shift | hold Shift |
