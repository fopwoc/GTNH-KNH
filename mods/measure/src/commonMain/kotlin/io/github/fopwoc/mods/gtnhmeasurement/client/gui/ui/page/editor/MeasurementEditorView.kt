    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                Section(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Button(
                                text =
                                    if (state.selectedCount > 1) "Delete ${state.selectedCount}"
                                    else "Delete",
                ...
                Section(title = "Shortcuts", modifier = Modifier.weight(2f).fillMaxHeight()) {
...
private fun ModeRow(state: MeasurementEditorModel, onSelectMode: (MeasurementMode) -> Unit) {
    Row(
        ...
        state.availableModes.forEach { mode ->
            ...
            Button(
                text =
                    if (selected) SegmentedControlDefaults.selectedLabel(label)
                    else StyledText.of(label),
                modifier = Modifier.weight(1f),
