...
object MeasurementClientController {
     ...
     * placement can be done at a fixed altitude. Shift + Cmd/Ctrl is "add to selection" and must
     * not descend. The game's sneak/jump key states are rewritten from the raw keyboard before the
     * player ticks (freecam reads the same bindings) and put back when the override ends.
     */
