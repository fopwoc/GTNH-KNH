...
internal object StructuredColorScenario {
  ...
  fun run(directory: Path): Result {
    ...
    val result = TileHistoryStore(directory).use { store ->
      val flatBytes =
  ...
  private fun segmentBytes(tiles: Int, recordBytes: Int): Long =
      12L + tiles * (12L + recordBytes)
}
