 ...
 * channel's width, or -1 when the channel has nothing for the pixel; channel 0 decides presence.
 * Return 0 (alpha 0) for a pixel the map should leave transparent.
 */
