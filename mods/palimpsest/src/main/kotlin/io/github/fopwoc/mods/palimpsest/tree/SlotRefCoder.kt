...
/**
 * Spells refs the way a segment file must: `slot ordinal offset`, where the slot names a machine in
 * this segment's slot table. Reading resolves back to runtime segment indices through the
 * [SegmentSet]; a ref into a segment this machine has never seen is corruption (a sync that dropped
 * files).
 */
