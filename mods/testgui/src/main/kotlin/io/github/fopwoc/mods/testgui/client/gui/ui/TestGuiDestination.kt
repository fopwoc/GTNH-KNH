...
sealed interface TestGuiDestination : NavKey {
    ...
    data object Controls : TestGuiDestination {
        ...
        override val summary: String = "Buttons, checkbox, slider, segmented controls, tabs, and toggles."
    }
    ...
    data object TextAndTooltips : TestGuiDestination {
        ...
        override val summary: String = "Wrapped text, Minecraft colors, styled spans, and hover tooltips."
    }

    data object InputsAndLists : TestGuiDestination {
        override val id: String = "inputs-lists"
        override val title: String = "Inputs & Lists"
        override val summary: String = "Hosted text fields, focus state, list selection, and commit flows."
    }
    ...
    data object LayoutAndScroll : TestGuiDestination {
        ...
        override val summary: String = "Panel, Box, Row, Column, weight, alignment, offsets, and scrolling."
    }

    data object StateLab : TestGuiDestination {
        override val id: String = "state-lab"
        override val title: String = "State Lab"
        override val summary: String = "Real ViewModels plus route-local remember vs rememberSaveable behavior."
    }

    data object Navigation : TestGuiDestination {
        override val id: String = "navigation"
        override val title: String = "Navigation"
        override val summary: String = "Typed back stacks, duplicates, replace-top, pop, and nested NavHost demos."
    }

    data object HostedStress : TestGuiDestination {
        override val id: String = "hosted-stress"
        override val title: String = "Hosted Stress"
        override val summary: String = "Dense hosted widgets, focus churn, list syncing, and fast state mutation."
    }
    ...
    data object ScrollClipStress : TestGuiDestination {
        ...
        override val summary: String = "Long scroll regions, offset badges, clipping pressure, and layout density changes."
    }
}

val testGuiDestinations: List<TestGuiDestination> = listOf(
...
val testGuiDestinationSaver: Saver<TestGuiDestination, String> = Saver(
