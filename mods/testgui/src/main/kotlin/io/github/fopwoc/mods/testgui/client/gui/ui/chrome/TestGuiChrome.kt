...
fun bodyTextStyle(wrap: Boolean = false): TextStyle = TextStyle(
...
fun accentTextStyle(wrap: Boolean = false): TextStyle = TextStyle(
...
fun TestGuiCard(
    ...
    Panel(
        modifier = modifier,
        backgroundColor = if (elevated) TestGuiPalette.ElevatedBackground else TestGuiPalette.SurfaceBackground,
