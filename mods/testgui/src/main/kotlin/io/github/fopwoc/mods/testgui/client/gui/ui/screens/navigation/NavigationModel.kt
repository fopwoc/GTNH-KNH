...
val navigationInnerDestinationSaver: Saver<NavigationInnerDestination, String> = Saver(
    save = { destination ->
        when (destination) {
    ...
    restore = { saved ->
        when {
            ...
            saved.startsWith("detail:") -> NavigationInnerDestination.Detail(saved.removePrefix("detail:"))
            else -> null
        }
    }
)
