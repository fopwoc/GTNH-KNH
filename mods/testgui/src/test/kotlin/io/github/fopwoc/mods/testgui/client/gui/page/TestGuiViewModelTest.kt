package io.github.fopwoc.mods.testgui.client.gui.page

import io.github.fopwoc.mods.testgui.client.gui.ui.page.controls.ControlsTab
import io.github.fopwoc.mods.testgui.client.gui.ui.page.controls.ControlsViewModel
import io.github.fopwoc.mods.testgui.client.gui.ui.page.controls.PowerPreset
import io.github.fopwoc.mods.testgui.client.gui.ui.page.hostedstress.HostedStressViewModel
import io.github.fopwoc.mods.testgui.client.gui.ui.page.inputs.InputsViewModel
import io.github.fopwoc.mods.testgui.client.gui.ui.page.layout.BoxAlignmentPreset
import io.github.fopwoc.mods.testgui.client.gui.ui.page.layout.LayoutTab
import io.github.fopwoc.mods.testgui.client.gui.ui.page.layout.LayoutViewModel
import io.github.fopwoc.mods.testgui.client.gui.ui.page.navigation.NavigationViewModel
import io.github.fopwoc.mods.testgui.client.gui.ui.page.overview.OverviewViewModel
import io.github.fopwoc.mods.testgui.client.gui.ui.page.scrollclipstress.ScrollClipStressViewModel
import io.github.fopwoc.mods.testgui.client.gui.ui.page.state.StateMode
import io.github.fopwoc.mods.testgui.client.gui.ui.page.state.StateViewModel
...
class TestGuiViewModelTest {
  ...
  fun stateViewModelRetainsTokenAndPrependsEvents() {
    ...
    assertTrue(
        first.stateFlow.value.eventLog.first().contains("Opened another top-level destination")
    )
  ...
  fun navigationViewModelTracksOuterAndInnerEvents() {
    ...
    assertTrue(
        viewModel.stateFlow.value.outerEvents.first().contains("Pushed another Navigation entry")
    )
  }
