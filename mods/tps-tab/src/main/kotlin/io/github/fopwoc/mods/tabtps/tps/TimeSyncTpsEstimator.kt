...
class TimeSyncTpsEstimator {
    @Volatile
    private var previousSample: TimeSyncSample? = null

    @Volatile
    private var latestMeasurement: TimedTpsMeasurement? = null
    ...
    fun recordServerTime(
        ...
        latestMeasurement = TimedTpsMeasurement(
            ...
            rawLine = "time-sync dimension=$dimensionId ticks=$ticksElapsed ms=${"%.2f".format(elapsedMs)}"
        )
        return latestMeasurement
    }
